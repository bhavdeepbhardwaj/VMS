            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row bg" id="converttoPDF">
                        <div class="pt-25 heading">Visitor Management<br />System</div>
                        ...
                        <div class="container pb-4 pt-4">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="text-center">
                                        <h2 class="pb-3">{{ Auth::user()->company_name }}</h2>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 ">
                                    <div class="text-center">
                                        <h3 class="text-black" style="margin-top: -70px;">Scan Below to Check-in<a
                                                href="{{ route('user.visitor', Auth::user()->company_name) }}"
                                                target="_blank" class=""><i
                                                    class="mdi mdi-arrow-down-bold-outline mdi-36px"></i>Click
                                                Here</a>
                                        </h3>
                        ...
                        <footer style="margin-bottom: -60px;">
                            <div class="text-center">
                                <img src="{{ asset('assets/img/footer.png') }}" alt="" style="width: 200px;">
                            </div>
                        </footer>
                    </div>
                </div>
