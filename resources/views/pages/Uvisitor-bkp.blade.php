            ...
            <div class="signup-content">
                <div class="signup-desc">
                    <div class="signup-desc-content">
                        ...
                        <img src="{{ asset('assets/visitor/images/signup-img.png') }}"
                            style="width: 350px; height: 285px; margin-left: -50px;" alt="" class="signup-img">
                ...
                <div class="signup-form-conent">
                    <div class="nav nav-fill my-8">
                        ...
                        <label class="nav-link shadow-sm step2   border ml-2 "></label>
                        <label class="nav-link shadow-sm step3   border ml-2 "></label>
                        <label class="nav-link shadow-sm step4   border ml-2 "></label>
                        <label class="nav-link shadow-sm step5   border ml-2 "></label>
                        <label class="nav-link shadow-sm step6   border ml-2 "></label>
                    </div>
                    ...
                    <form method="POST" action="{{ route('user.visitorstore') }}" class="signup-form"
                        ...
                        <div class="form-section">
                            {{-- Email --}}
                            <label for="" style="font-size: 22px;">E-mail:</label>
                            <input type="email" class="form-control mb-3" name="email" required>
                        </div>
                        <div class="form-section">
                            {{-- Phone --}}
                            <label for="" style="font-size: 22px;">Phone:</label>
                        ...
                        <div class="form-section">
                            ...
                            <textarea name="address" class="form-control mb-3" cols="30" rows="5"></textarea>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            {{-- <a href="javascript:0" class="btn btn-primary" onClick="take_snapshot()">Click</a> --}}
