...
<head>
    ...
    <style>
        ...
        * {
        ...
        table.button.redbtn table td {
            background: #8c1d40;
            color: #ffffff;
            border: 0px solid #777777;
        }

        table.button.redbtn:hover table td,
        table.button.redbtn:visited table td,
        table.button.redbtn:active table td {
            background: #000000;
            color: #fefefe;
        }

        table.button.yellowbtn table td {
            background: #ffc627;
            color: #000000;
            border: 0px solid #777777;
        }

        table.button.yellowbtn:hover table td,
        table.button.yellowbtn:visited table td,
        table.button.yellowbtn:active table td {
            background: #8c1d40;
            color: #ffc627;
        }
                                ...
                                <tr>
                                    <td>
                                                ...
                                                <tr>
                                                    <td class="colpad" style="padding: 30px 35px;">
                                                        ...
                                                        <p>Also, one of our executive will connect with you soon with
                                                            all details.</p>
                                                        <p>For any query or information, OR Email us at <a
                                        ...
                                        <table class="row" style="background: #ffffff; color:#000000;">
                                            <tbody>
                                                <tr>
                                                    <td class="colpad" style="padding: 50px 100px;">
                                                        <p style="" class=" text-center"><strong>Follow us on social
                                                            media:</strong></p>
                                                    <div style="" class="">
                                                        <ul style="list-style: none;  display: flex; ">
                                                            <li style=""><a
                                                                    href="https://www.linkedin.com/company/global-sync/"
                                                                    target="_blank"><img
                                                                        src="https://globalsync.com.au/wp-content/uploads/2022/12/LinkedIn.png" width="80"></a></li>
                                                            <li style="padding: 0px 20px;!important"><a
                                                                    href="https://www.facebook.com/GlobalSync1"
                                                                    target="_blank"><img
                                                                        src="https://globalsync.com.au/wp-content/uploads/2022/12/Facebook.png"
                                                                        style="" width="80"></a></li>
                                                            <li style="padding: 0px 20px;!important"><a
                                                                    href="https://www.youtube.com/@globalsync"
                                                                    target="_blank"><img
                                                                        src="https://globalsync.com.au/wp-content/uploads/2022/12/YouTube.png"
                                                                        style="" width="80"></a></li>
                                                        </ul>
                                                    </div>
                                                    <p style="" class=" text-center"><strong>It's Us</strong></p>
                                                    <p class=" text-center"><strong>Let us synchronise with your
                                                            business!</strong></p>
                                                    </td>
                                                </tr>
                                            </tbody>
