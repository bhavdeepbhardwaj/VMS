                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class=" align-content-center justify-content-sm-center text-center pt-2">
                            <h1 class="p-24px text-black">Visitor Management System Walk-through </h1>
                            <div href="/" title="GLOBALSYNC" class=" text-center">
                                <iframe width="560" height="400"
                                    src="https://www.youtube-nocookie.com/embed/eyzjasV1GlU" title="YouTube video player"
                                    frameborder="0"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-inline-block ">
                                            ...
                                            accept the <a href="{{ route('privacyPolicy') }}" target="_blank">Privacy
                                                Policy</a>
                                        </div>
