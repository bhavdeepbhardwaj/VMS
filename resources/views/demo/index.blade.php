            ...
            <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <p class="breadcrumbs"><span><a href="{{ route('demo.home') }}">Home</a></span>
                        <span><i class="mdi mdi-chevron-right"></i></span>Demo Registration
                    </p>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($demo as $cr)
                                            ...
                                            <tr>
                                                <td class="">
                                                    @if ($cr->pic != null)
                                                        <img src="{{ '../Demo/' . $cr->pic }}" class="rounded-circle"
                        ...
                        <div class="row">
                            <div class=" text-center">
                                <a href="/" title="Globalsync">
                                    <img class="pt-5 w-25" src="{{ asset('assets/img/logo/demo/logo.png') }}" alt="Globalsync" />
                                </a>
                            </div>
                                            ...
                                            <div class="avatar-upload">
                                                <div class="avatar-preview ec-preview">
                                                    <div class="imagePreview ec-div-preview">
                                                        @if ($demo != null)
                                                            <img class="ec-image-preview" src="../Demo/" id="pic"
                                                                alt="GLOBALSYNC"
    ...
    <script>
        function popupfunctioncall(visitorID) {
            $.ajax({
                ...
                url: '/Demo/popUpDemoRegistration/',
                data: {
                    'visitorID': visitorID
                },
                global: false,
