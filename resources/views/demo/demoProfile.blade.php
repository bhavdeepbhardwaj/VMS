                    ...
                    <div class="col-lg-4 col-xl-3">
                        <div class="profile-content-left profile-left-spacing">
                            <div class="text-center widget-profile px-0 border-0">
                                <form method="POST" action="{{ route('demo.profilesave') }}"
                                        ...
                                        <div class="avatar-upload">
                                            ...
                                            <div class="avatar-edit">
                                                <input type='file' hidden id="imageUpload"
                                                    ...
                                                    name="company_logo[]" value="{{ Auth::user()->company_logo }}"/>
                                                @error('company_logo')
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-select1"  placeholder="First name"
                                ...
                                <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                                    <div class="tab-pane-content mt-5">
                                        ...
                                        <form class="" method="POST"
                                            action="{{ route('demo.changePassword') }}">
                                            {{ csrf_field() }}
                                            <div class="row">
